...
# - Normal, 1-SD, CV
c3priorE3_1SD_opt1<-    matrix(c(0,34.9048,1, 0,1e8, # a
...
# - Normal, 1-SD, NCV
c3priorE3_1SD_opt2<-  matrix(c(0,36.98,1, 0,1e8, # a
...
# - Log-normal, 1-SD 
c3priorE3_1SD_opt3<-    matrix(c(0,35.4338,1, 0,1e8, # a
...
c3_E3_opt1_res <- bmd_single_continuous('exp-3', 'STDev', BMRF = 1, bkg_prob=-9999,
                                        PR=c3priorE3_1SD_opt1, DATA=c3Dat, sstat=c3ss,
