...
D = D*10
a <- single_continuous_fit(as.matrix(D),as.matrix(Y),sstat = F,BMD_TYPE = "sd" ,BMR = 2 ,model_type="FUNL",distribution = "normal",fit_type = "laplace")
...
fit<-ma_continuous_fit(D,Y,fit_type="mcmc",   samples=25000,burnin=2500,BMR=2.0,BMD_TYPE = "sd")
fit<-ma_continuous_fit(D,Y,fit_type="laplace",samples=25000,burnin=2500,BMR=2.0,BMD_TYPE = "sd")
