...
M = matrix(0,nrow=25,ncol=4)
colnames(M) <- c("Dose","Resp","","")
M[,1] <- c(0,0,0,0,18,18,18,18,20,20,20,20,30,30,30,30,35,35,35,35,40,40,40,40,40)
M[,2] <- c(39,38.4,36.3,37.1,40.2,45.3,42.1,38.3,42.5,45.2,40.1,39.8,50.1,53.4,48.2,52.1,56.1,50.4,53.2,
...
qr <- 37.52*(exp(1.05611)-(exp(1.05611)-1)*exp(-(0.0118549*rd)^1.46608))
lines(rd,qr,col=2)
