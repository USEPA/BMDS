...
M[,1] <- c(0,0,0,0,0,18,18,18,18,20,20,20,20,30,30,30,30,35,35,35,35,49,49,49,49,49)/49
...
system.time({d = single_continuous_fit(M[,1,drop=F],M[,2,drop=F],sstat=F, 
                                       ...
                                       fit_type="laplace",model_type = "polynomial",degree = 1)})
...
M2[, 4]      <- c(0.26,0.26,0.35,0.21,0.33)
