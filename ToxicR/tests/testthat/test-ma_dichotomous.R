...
test_that("Defaults", {
     ...
     validate_model( AA$Fitted_Model_3 ,  "Model:  Logistic" ,  c(-2.0069607207327, 0.0463222123387509) ,  c(14.2821369829316, 11.7611052273976, 18.9167440555661) )
     validate_model( AA$Fitted_Model_4 ,  "Model:  Log-Logistic" ,  c(-2.90509719095083, -3.22382968699211, 0.770460283795502) ,  c(3.79034439690537, 1.37987439309905, 9.29526839843571) )
     validate_model( AA$Fitted_Model_5 ,  "Model:  Log-Probit" ,  c(-2.76563341583274, -2.03205435911903, 0.487681754992638) ,  c(4.65955128862954, 1.88253828334611, 12.0003951662748) )
     ...
     validate_model( AA$Fitted_Model_7 ,  "Model:  Probit" ,  c(-1.22897249357605, 0.0286868893347652) ,  c(13.3264085482876, 10.9912280971799, 17.4597665445259) )
