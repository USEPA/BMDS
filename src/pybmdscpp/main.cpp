...
PYBIND11_MODULE(bmdscore, m) {
  ...
  py::class_<python_dichotomous_analysis>(m, "python_dichotomous_analysis")
      ...
      .def_readwrite("countAllParmsOnBoundary", &python_dichotomous_analysis::countAllParmsOnBoundary);
  ...
  py::class_<python_continuous_analysis>(m, "python_continuous_analysis")
      ...
      .def_readwrite("countAllParmsOnBoundary", &python_continuous_analysis::countAllParmsOnBoundary);
