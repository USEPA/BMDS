...
struct MA_PRIORS {
	double *mean_logistic; double *sd_logistic; 
	double *mean_probit;   double *sd_probit  ;
	double *mean_loglogit; double *sd_loglogit; 
	double *mean_logprobit; double *sd_logprobit; 
	double *mean_weibull;  double *sd_weibull; 
	double *mean_gamma;    double *sd_gamma; 
	double *mean_mult2;    double *sd_mult2;
	double *mean_qlinear;  double *sd_qlinear; 
	double *mean_hill;     double *sd_hill; 
};

// Result structure for model averaging
struct MA_ANALYSIS {
	double BMD; double BMDL; double BMDU; 
	double *bmd;
	double *bmdl; 
	double *bmdu; 
	double *post_probs; 
