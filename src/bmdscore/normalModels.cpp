...
double start_distance(unsigned n, const double *b, double *grad, void *data) {
...
//         risk type.
///////////////////////////////////////////////////////////////////////
Eigen::MatrixXd normalLLModel::starting_value(
  ...
  for (int i = 0; i < theta.rows(); i++) x[i] = theta(i, 0);
...
//
//////////////////////////////////////////////////////////
double normalLLModel::equality_boundG(
    Eigen::MatrixXd theta, contbmd BMDType, double BMD, double BMRF, bool isInc, double tail_prob
) {
  double returnV = 0.0;
  switch (BMDType) {
...
///////////////////////////////////////////////////////////////////////
Eigen::MatrixXd normalLLModel::eqConst_gradient(
    Eigen::MatrixXd v, contbmd type, double BMD, double BMRF, bool isIncreasing, double tail_prob
) {
...
Eigen::MatrixXd normalLLModel::mean(Eigen::MatrixXd theta) { return mean(theta, X); }
...
Eigen::MatrixXd normalLLModel::variance(Eigen::MatrixXd theta) { return variance(theta, X); }
