...
*/
double lognormalHILL_BMD_NC::bmd_start_absolute(
...
std::vector<double> lognormalHILL_BMD_NC::bmd_start_absolute_clean(
...
unbounded - nu
*/
double lognormalHILL_BMD_NC::bmd_start_reldev(
    unsigned n, const double *b, double *grad, void *data
) {
  start_data *sdata = (start_data *)data;
  Eigen::MatrixXd theta = sdata->theta;
...
std::vector<double> lognormalHILL_BMD_NC::bmd_start_reldev_clean(
    std::vector<double> x, double BMRF, double BMD, bool isIncreasing
) {
  double t;
  Eigen::MatrixXd d(2, 1);
...
unbounded - nu
************************************************/
double lognormalHILL_BMD_NC::bmd_start_stddev(
    unsigned n, const double *b, double *grad, void *data
) {
...
std::vector<double> lognormalHILL_BMD_NC::bmd_start_stddev_clean(
    std::vector<double> x, double BMRF, double BMD, bool isIncreasing
) {
...
unbounded - nu
***********************/
double lognormalHILL_BMD_NC::bmd_start_point(
    unsigned n, const double *b, double *grad, void *data
) {
  start_data *sdata = (start_data *)data;
  Eigen::MatrixXd theta = sdata->theta;
...
std::vector<double> lognormalHILL_BMD_NC::bmd_start_point_clean(
    std::vector<double> x, double BMRF, double BMD, bool isIncreasing
) {
  double temp = 0;
...
unbounded - nu
*****************************/
double lognormalHILL_BMD_NC::bmd_start_extra(
    unsigned n, const double *b, double *grad, void *data
) {
  start_data *sdata = (start_data *)data;
  Eigen::MatrixXd theta = sdata->theta;
...
std::vector<double> lognormalHILL_BMD_NC::bmd_start_extra_clean(
    std::vector<double> x, double BMRF, double BMD, bool isIncreasing
) {
  double temp = 0.0;
...
unbounded - nu
*/
double lognormalHILL_BMD_NC::bmd_start_hybrid_extra(
    unsigned n, const double *b, double *grad, void *data
) {
  start_data *sdata = (start_data *)data;
...
std::vector<double> lognormalHILL_BMD_NC::bmd_start_hybrid_extra_clean(
...
/*************************************************
// Functions: lognormalHILL_BMD_NC::bmd_absolute(Eigen::MatrixXd theta, double BMRF, bool
isIncreasing)
//			  lognormalHILL_BMD_NC::bmd_stdev(Eigen::MatrixXd theta, double BMRF, bool
isIncreasing)
//			  lognormalHILL_BMD_NC::bmd_reldev(Eigen::MatrixXd theta, double BMRF, bool
isIncreasing)
...
code
//            in  lognormalHILL_BMD_NC::bmd_absolute(Eigen::MatrixXd theta, double BMRF, bool
isIncreasing)
//
**************************************************/
double lognormalHILL_BMD_NC::bmd_absolute_bound(
...
double lognormalHILL_BMD_NC::bmd_stdev_bound(
    Eigen::MatrixXd theta, double BMD, double BMRF, bool isIncreasing
) {
...
double lognormalHILL_BMD_NC::bmd_reldev_bound(
    Eigen::MatrixXd theta, double BMD, double BMRF, bool isIncreasing
) {
  Eigen::MatrixXd d(1, 1);
  d(0, 0) = 0.0;
...
double lognormalHILL_BMD_NC::bmd_extra_bound(
    Eigen::MatrixXd theta, double BMD, double BMRF, bool isIncreasing
) {
  Eigen::MatrixXd d(1, 1);
  d(0, 0) = 0.0;
...
double lognormalHILL_BMD_NC::bmd_point_bound(
    Eigen::MatrixXd theta, double BMD, double BMRF, bool isIncreasing
) {
...
/************************************************
////////////////////////////////////////////////////////////////////////
// Function:  double lognormalHILL_BMD_NC::bmd_hybrid_extra(Eigen::MatrixXd theta, double BMRF, bool
isIncreasing,,double BPROB)
...
////////////////////////////////////////////////////////////////////////
***********************************************/
double lognormalHILL_BMD_NC::bmd_hybrid_extra_bound(
...
////////////////////////////////////////////////////////////////////////
**************************************************************************/
double lognormalHILL_BMD_NC::bmd_hybrid_extra(
