...
Eigen::VectorXd continuous_poly2_transform(const Eigen::VectorXd& params, const Eigen::MatrixXd& X);
...
double no_priorr(const Eigen::VectorXd& theta, const Eigen::MatrixXd& prior_spec);
