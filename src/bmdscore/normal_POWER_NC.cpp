...
*/
double normalPOWER_BMD_NC::bmd_start_absolute(
...
std::vector<double> normalPOWER_BMD_NC::bmd_start_absolute_clean(
...
unbounded - nu
*/
double normalPOWER_BMD_NC::bmd_start_reldev(unsigned n, const double *b, double *grad, void *data) {
  start_data *sdata = (start_data *)data;
  Eigen::MatrixXd theta = sdata->theta;
...
std::vector<double> normalPOWER_BMD_NC::bmd_start_reldev_clean(
    std::vector<double> x, double BMRF, double BMD, bool isIncreasing
) {
  double t;
...
unbounded - nu
*/
double normalPOWER_BMD_NC::bmd_start_stddev(unsigned n, const double *b, double *grad, void *data) {
  start_data *sdata = (start_data *)data;
...
std::vector<double> normalPOWER_BMD_NC::bmd_start_stddev_clean(
    std::vector<double> x, double BMRF, double BMD, bool isIncreasing
) {
...
unbounded - nu
*/
double normalPOWER_BMD_NC::bmd_start_point(unsigned n, const double *b, double *grad, void *data) {
  start_data *sdata = (start_data *)data;
  Eigen::MatrixXd theta = sdata->theta;
...
std::vector<double> normalPOWER_BMD_NC::bmd_start_point_clean(
    std::vector<double> x, double BMRF, double BMD, bool isIncreasing
) {
  double temp = 0;
  temp += BMRF - x[0];
...
unbounded - nu
*/
double normalPOWER_BMD_NC::bmd_start_extra(unsigned n, const double *b, double *grad, void *data) {
  start_data *sdata = (start_data *)data;
  Eigen::MatrixXd theta = sdata->theta;
...
std::vector<double> normalPOWER_BMD_NC::bmd_start_extra_clean(
    std::vector<double> x, double BMRF, double BMD, bool isIncreasing
) {
  double temp = 0.0;
...
unbounded - nu
*/
double normalPOWER_BMD_NC::bmd_start_hybrid_extra(
    unsigned n, const double *b, double *grad, void *data
) {
  start_data *sdata = (start_data *)data;
...
std::vector<double> normalPOWER_BMD_NC::bmd_start_hybrid_extra_clean(
...
// Functions: normalPOWER_BMD_NC::bmd_absolute(Eigen::MatrixXd theta, double BMRF, bool
// isIncreasing)
//			  normalPOWER_BMD_NC::bmd_stdev(Eigen::MatrixXd theta, double BMRF, bool
//isIncreasing) 			  normalPOWER_BMD_NC::bmd_reldev(Eigen::MatrixXd theta, double BMRF, bool
//isIncreasing)
...
// code
//            in  normalPOWER_BMD_NC::bmd_absolute(Eigen::MatrixXd theta, double BMRF, bool
//            isIncreasing)
//
double normalPOWER_BMD_NC::bmd_absolute_bound(
...
double normalPOWER_BMD_NC::bmd_stdev_bound(
    Eigen::MatrixXd theta, double BMD, double BMRF, bool isIncreasing
) {
...
double normalPOWER_BMD_NC::bmd_reldev_bound(
    Eigen::MatrixXd theta, double BMD, double BMRF, bool isIncreasing
) {
  Eigen::MatrixXd d(1, 1);
  d(0, 0) = 0.0;
...
double normalPOWER_BMD_NC::bmd_extra_bound(
    Eigen::MatrixXd theta, double BMD, double BMRF, bool isIncreasing
) {
  Eigen::MatrixXd d(1, 1);
  d(0, 0) = 0.0;
...
double normalPOWER_BMD_NC::bmd_point_bound(
    Eigen::MatrixXd theta, double BMD, double BMRF, bool isIncreasing
) {
...
////////////////////////////////////////////////////////////////////////
// Function:  double normalPOWER_BMD_NC::bmd_hybrid_extra(Eigen::MatrixXd theta, double BMRF, bool
...
//
////////////////////////////////////////////////////////////////////////
double normalPOWER_BMD_NC::bmd_hybrid_extra_bound(
...
//
////////////////////////////////////////////////////////////////////////
double normalPOWER_BMD_NC::bmd_hybrid_extra(
