...
*/
double normalPOLYNOMIAL_BMD_NC::bmd_start_absolute(
...
std::vector<double> normalPOLYNOMIAL_BMD_NC::bmd_start_absolute_clean(
...
*/
double normalPOLYNOMIAL_BMD_NC::bmd_start_reldev(
    unsigned n, const double *b, double *grad, void *data
) {
  double t;
  start_data *sdata = (start_data *)data;
 ...
 */
std::vector<double> normalPOLYNOMIAL_BMD_NC::bmd_start_reldev_clean(
    std::vector<double> x, double BMRF, double BMD, bool isIncreasing
) {
  double t;
...
unbounded - nu
*/
double normalPOLYNOMIAL_BMD_NC::bmd_start_stddev(
    unsigned n, const double *b, double *grad, void *data
) {
  // key off of mu in this one
  start_data *sdata = (start_data *)data;
...
std::vector<double> normalPOLYNOMIAL_BMD_NC::bmd_start_stddev_clean(
    std::vector<double> x, double BMRF, double BMD, bool isIncreasing
) {
...
unbounded - nu
*/
double normalPOLYNOMIAL_BMD_NC::bmd_start_point(
    unsigned n, const double *b, double *grad, void *data
) {
...
std::vector<double> normalPOLYNOMIAL_BMD_NC::bmd_start_point_clean(
    std::vector<double> x, double BMRF, double BMD, bool isIncreasing
) {
  double temp = 0.0;
  double sum = 0.0;
...
unbounded - nu
*/
double normalPOLYNOMIAL_BMD_NC::bmd_start_extra(
    unsigned n, const double *b, double *grad, void *data
) {
  start_data *sdata = (start_data *)data;
  Eigen::MatrixXd theta = sdata->theta;
...
std::vector<double> normalPOLYNOMIAL_BMD_NC::bmd_start_extra_clean(
    std::vector<double> x, double BMRF, double BMD, bool isIncreasing
) {
  double temp = 0.0;
...
unbounded - nu
*/
double normalPOLYNOMIAL_BMD_NC::bmd_start_hybrid_extra(
    unsigned n, const double *b, double *grad, void *data
) {
  start_data *sdata = (start_data *)data;
...
std::vector<double> normalPOLYNOMIAL_BMD_NC::bmd_start_hybrid_extra_clean(
...
// Functions: normalPOLYNOMIAL_BMD_NC::bmd_absolute(Eigen::MatrixXd theta, double BMRF, bool
// isIncreasing)
//			  normalPOLYNOMIAL_BMD_NC::bmd_stdev(Eigen::MatrixXd theta, double BMRF,
//bool isIncreasing) 			  normalPOLYNOMIAL_BMD_NC::bmd_reldev(Eigen::MatrixXd theta, double BMRF, bool
//isIncreasing)
//            normalPOLYNOMIAL_BMD_NC::bmd_point(Eigen::MatrixXd theta, double BMRF, bool
//            isIncreasing)
// Purpose :  return the BMD given the parameter values theta and the BMRF. Note they are  call the
// code
//            in  normalPOLYNOMIAL_BMD_NC::bmd_absolute(Eigen::MatrixXd theta, double BMRF, bool
//            isIncreasing)
//
double normalPOLYNOMIAL_BMD_NC::bmd_absolute_bound(
...
double normalPOLYNOMIAL_BMD_NC::bmd_stdev_bound(
    Eigen::MatrixXd theta, double BMD, double BMRF, bool isIncreasing
) {
...
double normalPOLYNOMIAL_BMD_NC::bmd_reldev_bound(
    Eigen::MatrixXd theta, double BMD, double BMRF, bool isIncreasing
) {
  Eigen::MatrixXd d(2, 1);
  d << 0.0, BMD;
...
double normalPOLYNOMIAL_BMD_NC::bmd_extra_bound(
    Eigen::MatrixXd theta, double BMD, double BMRF, bool isIncreasing
) {
  Eigen::MatrixXd d(1, 1);
  d(0, 0) = 0.0;
...
double normalPOLYNOMIAL_BMD_NC::bmd_point_bound(
    Eigen::MatrixXd theta, double BMD, double BMRF, bool isIncreasing
) {
...
////////////////////////////////////////////////////////////////////////
// Function:  double normalPOLYNOMIAL_BMD_NC::bmd_hybrid_extra(Eigen::MatrixXd theta, double BMRF,
...
//
////////////////////////////////////////////////////////////////////////
double normalPOLYNOMIAL_BMD_NC::bmd_hybrid_extra_bound(
...
//            isIncreasing)
//
double normalPOLYNOMIAL_BMD_NC::bmd_absolute(
...
//
////////////////////////////////////////////////////////////////////////
double normalPOLYNOMIAL_BMD_NC::bmd_hybrid_extra(
