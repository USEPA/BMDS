...
double start_distanceLN(unsigned n, const double *b, double *grad, void *data) {
...
///
///////////////////////////////////////////////////////////////////////
Eigen::MatrixXd lognormalLLModel::starting_value(
...
///////////////////
double lognormalLLModel::equality_boundG(
    Eigen::MatrixXd theta, contbmd BMDType, double BMD, double BMRF, bool isInc, double tail_prob
) {
  double returnV = 0.0;
  switch (BMDType) {
...
///////////////////////////////////////////////////////////////////////
Eigen::MatrixXd lognormalLLModel::eqConst_gradient(
...
Eigen::MatrixXd lognormalLLModel::mean(Eigen::MatrixXd theta) { return mean(theta, X); }
...
Eigen::MatrixXd lognormalLLModel::variance(Eigen::MatrixXd theta) { return variance(theta, X); }
