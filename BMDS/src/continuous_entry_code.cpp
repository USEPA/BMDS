...
bmd_analysis laplace_Normal(Eigen::MatrixXd Y,Eigen::MatrixXd X,
  ...
  case cont_model::power:
    Rcout << "Running Power Model Normality Assumption." << endl; 
    ...
    break; 
  case cont_model::hill:
    Rcout << "Running Hill Model  Normality Assumption." << endl;
    ...
    break; 
  case cont_model::exp_3:
    cout << "Running Exponential 3 Model Normality Assumption." << endl;
    if (is_increasing){
  ...
  case cont_model::exp_5:
  default: 
     cout << "Running Exponential 5 Model Normality Assumption." << endl;
